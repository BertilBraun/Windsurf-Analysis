...
def compute_vidstab_transforms(input_video: str | os.PathLike) -> VidStab:
    ...
    stabilizer = VidStab()
    stabilizer.gen_transforms(input_path=input_video, smoothing_window=min(10, video_properties.total_frames - 1))
...
def stabilize(input_video: str | os.PathLike, output_video: str | os.PathLike | None = None):
    ...
    stabilizer.stabilize(input_path=input_video, output_path=output_video, use_stored_transforms=True)
