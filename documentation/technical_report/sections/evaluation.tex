...
development-set interpretation rather than a general ranking claim.  The checked-in
bootstrap script records video-level resampling, pooled-count recomputation, percentile
intervals, NumPy's PCG64 generator, and seed 20260918~\cite{projectresources}.
...
production outputs span seven videos because \texttt{input6} instead contains an
