...
\begin{equation}
\begin{aligned}
\text{video} &\rightarrow \text{boxes + landmarks}\\
...
The detector is a one-class YOLO pose model trained from manually reviewed boxes and
two windsurf-specific landmarks: the boom--mast junction and mast tip.  Every box is
also converted into a compact color descriptor.  Independently, background features
