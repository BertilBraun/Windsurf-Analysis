...
boom--mast junction and mast tip.  Every box is also converted into a compact color descriptor.  Independently, background features
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[t]{0.38\textwidth}
    \centering
    \includegraphics[width=\linewidth]{pose-anchor-geometry.png}
    \caption{Pose-derived framing geometry.  The detector box and center (orange),
    boom--mast junction and mast tip (cyan), and rider-relative anchor (magenta).}
    \label{fig:pose-anchor-geometry}
  \end{subfigure}\hfill
  \begin{subfigure}[t]{0.56\textwidth}
    \centering
    \includegraphics[width=\linewidth]{tracking-sail-color-similarity.png}
    \caption{Production color descriptor on consecutive crops of two sails.
    Repeated observations score highly, while cross-sail matches reach the lower
    bound.  This hand-selected example explains the cue rather than measuring it.}
    \label{fig:tracking-sail-color}
  \end{subfigure}
  \caption{Task-specific visual signals used by the system: rig pose for framing and
  sail appearance for identity association.}
  \label{fig:domain-signals}
\end{figure*}

\Cref{fig:pose-anchor-geometry} introduces the task-specific pose keypoints and the
framing signals derived from them.  Their temporal treatment is described in
\Cref{sec:pose}.
