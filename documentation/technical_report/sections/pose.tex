...
while the distance from that junction to the mast tip provides a physical scale cue
...
\begin{figure}[t]
  ...
  (magenta) and a mast-length scale signal.  Production rendering smooths these
