...
current split is an image-level development split and may contain frames from the same
source sequence on both sides; a sequence-grouped held-out set is required for a
