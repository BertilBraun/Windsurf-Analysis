...
uses $C^{\mathrm{appearance}}=-\log s_a$.  The coefficient 11.630 is the frozen value
from historical development-set tuning, whose detailed search trace is unavailable.
