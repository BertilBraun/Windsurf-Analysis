...
\begin{equation}
 S_a=\operatorname{clip}_{(0,1]}(1-\gamma_a d),
 \qquad \gamma_a=11.63.
 \label{eq:appearance}
\end{equation}
...
development set.  The implementation uses small numerical margins at the interval
boundaries to keep the logarithm well defined.
