    ...
    return (
        <section className="rounded-3xl border border-slate-200 bg-white/90 backdrop-blur p-6 sm:p-8 shadow-lg">
            <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-sm text-slate-600">{t('screens.signup.subtitle')}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                <label className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-slate-700">{t('screens.signup.labels.email')}</span>
                    <input
                ...
                <label className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-slate-700">{t('screens.signup.labels.password')}</span>
                    <input
                ...
                <label className="flex flex-col gap-1">
                    <span className="text-xs font-semibold text-slate-700">
                        {t('screens.signup.labels.repeatPassword')}
                    </span>
                    <input
            ...
            <div className="mt-6 text-center text-sm text-slate-600">
                {t('screens.signup.footer.haveAccount')}{' '}
                <Button
                    type="button"
                    variant="unstyled"
                    size="none"
                    ...
                    text={t('screens.signup.footer.login')}
                />
            </div>
        </section>
    )
