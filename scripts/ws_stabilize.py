...
try:
    ...
    from util import progress_bar as tqdm
...
def main():
    ...
    parser.add_argument("-o", "--output", help="Output file (single input) or directory (multiple inputs). If omitted, defaults to current directory.")
