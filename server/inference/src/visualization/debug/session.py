...
from server.inference.src.visualization.debug.draw import compose_side_by_side
from server.inference.src.visualization.debug.viewer import ViewerCV2, ViewerInterface
...
class Cv2DebugSession(DebugSession):
    ...
    def from_video(video_path: Path) -> Cv2DebugSession:
        ...
        from server.inference.src.util.video_io import VideoReader  # type: ignore
